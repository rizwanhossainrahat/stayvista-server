...
// middleware
const corsOptions = {
  origin: ['http://localhost:5173', 'http://localhost:5174','https://stayvista-cbd60.web.app','https://stayvista-cbd60.firebaseapp.com'],
  credentials: true,
...
// const uri = `mongodb+srv://stayvista:lWPoAdpwuEZzLoAi@main.mq0mae1.mongodb.net/?retryWrites=true&w=majority&appName=Main`
const uri = "mongodb+srv://stayvista:lWPoAdpwuEZzLoAi@cluster0.iwcqk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
  ...
  try {
    ...
    app.get('/room/:id', async (req, res) => {
      ...
      sendEmail(bookingData?.host?.email, {
        ...
        //change room availavaility status  in rooms data collection
